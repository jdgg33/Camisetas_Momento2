...
public class CreateActivity extends BaseActivity {
    ...
    private void save(CamisetasModel model) {
                        ...
                        public void onComplete(@NonNull Task<DocumentReference> task) {
                            if(task.isSuccessful()){
                                if(task.getResult() != null){
                                    makeSimpleAlertDialog("Success", "Camiseta saved");
                                    clear();
                                }else{
                                    makeSimpleAlertDialog("Warning","Camiseta not saved");
                                }
                            }else{
    ...
    private void clear(){
        ...
        iv_create_image.setImageResource(R.drawable.ic_menu_call);
    }
        ...
        if(requestCode == GALLERY_INTENT && requestCode == RESULT_OK){
            ...
            filepath.putFile(uri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    Toast.makeText(CreateActivity.this, "cargo corretamente ", Toast.LENGTH_SHORT).show();
                }
            });
        }
    }
